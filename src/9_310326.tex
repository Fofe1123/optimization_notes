...
\begin{proof}
    ...
    Fix $\gamma \in \R$, assume $V_\gamma \neq \emptyset$. Define the $\gamma$-slice $S = \set{(x,\gamma) : f(x) \le \gamma}$. Observe that $S = \epi{f} \cap \set{(x,\gamma) : x \in \Rn}$. We already know $\epi{f}$ closed convex, so 
