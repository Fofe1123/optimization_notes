...
\begin{theorem}[Projection theorem, Book 1.1.9]

    Let $C$ be a nonempty convex closed subset of $\Rn$, $z \in \Rn$. Then there exists a unique vector $x^* \in C$ (the projection of $z$ on $C$) that minimizes the function $f(x) = \norm{x- z}$ over $C$. 
...
\begin{proof}
    ...
    \begin{align*}
        \langle z - x^*_1, x^*_2-x^*_1 \rangle &\le 0 \quad \forall z \in C \\
        \langle z - x^*_2, x^*_2-x^*_1 \rangle &\le 0 \quad \forall z \in C
    \end{align*}
